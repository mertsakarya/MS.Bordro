...
namespace MS.Bordro.Infrastructure.Attributes
{
    ...
    public class BordroRegularExpressionAttribute : RegularExpressionAttribute, IClientValidatable
    {
        ...
        public BordroRegularExpressionAttribute(string propertyName) : base(propertyName)
        {
